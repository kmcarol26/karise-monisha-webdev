...
(function(){
    ...
    function loginController($location,UserService){ //injecting UserService
        ...
        function init() {  //This function is always executed when controller is inititated. So all logic which must
                            // be done when controller is initiated goes here. The name can be anything other than init
        }
        init();
